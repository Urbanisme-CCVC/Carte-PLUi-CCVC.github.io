...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:2154',
            //extent: [483679.898747, 6587060.358104, 513751.674666, 6608168.520000],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([475797.132906, 6585684.759856, 523532.835426, 6609495.465423], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carte interactive PLUi / CC des Vallées du Clain</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (194 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'RECHERCHER PAR ADRESSE (LOUPE) OU PARCELLE (JUMELLE) CI-DESSOUS.<br />PUIS CLIQUEZ SIMPLEMENT SUR VOTRE PARCELLE POUR CONNAÎTRE LES INFORMATIONS DU PLUI.<br />! CE DOCUMENT N\'EST PAS OPPOSABLE AUX TIERS !';
            }
